...
import BattleRowVideo from "./images/battle_row.mp4";
...
const Projects = () => {
  ...
  const renderMedia = (mediaPath) => {
    if (mediaPath.endsWith(".mp4")) {
      return <video controls src={mediaPath} alt="Battle Row Video" />;
    } else {
      return <img src={mediaPath} alt="House on Battle Row" />;
    }
  };
